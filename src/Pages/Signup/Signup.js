                    ...
                    <div
                        ...
                        <div
                           ...
                           <img src="https://tecdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp"
                                class="lg:w-full md:w-3/4 sm:w-2/4 sm:mx-auto"  alt="" srcset="" />
                        </div>
                        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                            <form className='p-5 m-5 rounded-md '>
                                <div
                                    class="flex flex-row items-center justify-center lg:justify-start">
                                    <p class="mb-0 mr-4 text-2xl text-white">Sign Up With</p>
                                    <button
                                        type="button"
                                        data-te-ripple-init
                                ...
                                <div
                                    class="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-white after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
                                    <p
                                ...
                                <div class="relative mb-6 border-b" data-te-input-wrapper-init>
                                    ...
                                    <label
                                        ...
                                        class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-white dark:peer-focus:text-white"
                                    >Email address
                                    </label>
                                </div>
                                ...
                                <div class="text-center lg:text-left">
                                    ...
                                    <p class="text-white mt-2 mb-0 pt-1 text-sm font-semibold">
